...
TE identification and classification using EDTA

TE masking using RepeatMasker

Construction of a pan-genome TE library

Summary of TE annotation results

TE presence/absence variation (PAV) profiling
