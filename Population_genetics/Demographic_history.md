...
**2 Demographic models are specified backward in time**
...
**Example two-population demographic models**
...
**5 Model 5: different early and recent gene flow**
...
**Mutation rate and parameter scaling**
...
**Run a first fastsimcoal2 optimization**
...
**Recommended final-analysis settings**
...
**Run many independent optimization replicates**
...
**1 Example R code for AIC calculation**
...
**Visualize observed and expected SFS**
...
**Prepare the maximum-likelihood model**
...
**Recalculate likelihood repeatedly**
...
**Compare likelihood distributions in R**
...
**Collect AIC values for all models**
...
**Extract VCF header and variant records**
...
**Generate an SFS for each bootstrap replicate**
...
**Fit each bootstrap SFS repeatedly**
...
**Select the best run for every bootstrap replicate**
...
**Interpret migration parameters carefully**
...
**Example batch runner for one model**
...
**Example extraction of best-run likelihoods**
...
**Example likelihood ranking in R**
...
**Example parameter stability plot**
...
**Generate a diploid consensus sequence**
...
**Convert the diploid consensus to PSMCFA**
...
**Combine PSMC bootstrap results**
...
**Run PSMC for multiple individuals**
...
**Prepare callable masks for MSMC2**
...
**Generate MSMC input with generate_multihetsep.py**
...
**MSMC2 within-population Ne analysis**
...
**MSMC2 analysis for population 2**
...
**Convert all chromosomes for one population**
...
**Include all population samples**
...
**Mask inaccessible genomic regions**
...
**Estimate population-size history with SMC++**
...
**Interpreting SMC++ split estimates**
...
**SMC++ bootstrap or chromosome resampling**
...
**Consistent filtering across methods**
